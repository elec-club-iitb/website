...
module Jekyll
  ...
  class CategoryPage < Page
    ...
    def initialize(template_path, name, site, base, category_dir, category)
      ...
      if File.exist?(template_path)
        ...
        self.data['title']       = "Community Blog"
        # Set the meta-description for this page.
        meta_description_prefix  = site.config['category_meta_description_prefix'] || 'Blog posts under category '
  ...
  module Filters
    ...
    def category_links(categories)
      ...
      category_base = @context.registers[:site].config['category_dir']
      base_dir = "#{baseurl}/#{category_base}"
